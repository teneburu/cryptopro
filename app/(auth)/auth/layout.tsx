        ...
        <div className="relative flex min-h-screen flex-col">
          <main className="flex-1">
            <div className='flex flex-col relative w-full min-h-screen items-center justify-center'>
              <Image src="/gradient/gradient-blue-rose.png" alt="Orange Gradient Background Top" fill className="object-cover pointer-events-none -z-10" priority sizes="(max-width: 768px) 100vw, (max-width: 1000px) 100vw, (max-width: 2560px) 100vw"/>
